...
<img style={{ height: '500px' }} src="tweet.png" />
...
- Uses variety of eventListeners ('install', 'activate', 'fetch', 'message')
- Works off Promises
- Works only through HTTPS & localhost
- Utilizes the Cache Storage API
...
1. Check application tab for service workers
2. Refresh and notice network tab
3. Go offline and watch the app break
